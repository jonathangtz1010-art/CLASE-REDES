...
def parse_status(resp: str):
    ...
    if active:
        ...
        state_short = "ACTIVO"
        color = "green"
        message = "La luz entrante medida por el LDR superó el umbral y el circuito activó físicamente los indicadores."
        recommendation = "La gráfica continúa capturando porque el sistema está activo."
    else:
        state_label = "Sistema en reposo"
        state_short = "REPOSO"
        color = "red"
        message = "La luz entrante medida por el LDR no supera el umbral. El circuito permanece en reposo."
        recommendation = "La gráfica queda congelada hasta que el circuito vuelva a estado activo."
